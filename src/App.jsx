      ...
      <div style={styles.rightHeaderDock}>
        ...
        <div className="glass-glow" style={styles.panel}>
          ...
          <div style={styles.selectOnlyRow}>
            <div style={styles.blocLeftTools}>
              <select
                value={blocActif}
                onChange={(e) => {
            ...
            <div
              style={{
                ...styles.floatingHeaderDock,
                borderColor: weekGlowSoft,
                boxShadow: `0 16px 44px rgba(0,0,0,0.34), 0 0 28px ${weekGlowSoft}, inset 0 1px 0 rgba(255,255,255,0.08)`,
              }}
            >
              <button
                onClick={() => setShowCalendarPanel(true)}
                style={{
                  ...styles.weekCalendarButton,
                  borderColor: weekGlowColor,
                  boxShadow: `0 0 18px ${weekGlowSoft}, inset 0 1px 0 rgba(255,255,255,0.18)`,
                }}
